...
Q_input     = [0  0  10  0  0  0]; %facendo così impongo un peso solo alla omega
R_input     = [ 1 10;
                1 10;
                1  1;
                1  5;
                1  1;
                10 10]; %quanto peso dare al passo pala e alla coppia, ad esempio a vento alto
                        %ho bisogno di entrambi i controlli per contrastare la forza
