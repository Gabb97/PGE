function std_graph_sub( i , position , title_str , ylabel_str , xlabel_str , x_val , y_val , effects , linewidth );

figure(i);
hold on;
zoom on;

subplot(position(1),position(2),position(3)); hk = plot ( x_val , y_val , effects );
ht = title ( title_str );
