function wind_grid_print(time_gust,gust_name,grid_size,grid_resolution,time_step,z_hub,V_hub,d,V_gust_hub,V_gust,time_trans_1,time_trans_2, dat_file_name )
...
fpc=fopen( strcat(dat_file_name,'\',gust_name) , 'w' );
if fpc<0
    fprintf('ERROR in opening [%s] file!!\n', strcat(dat_file_name,'\',gust_name));
    keyboard
end
...
for t=1:1:(time_trans_1/time_step),
    ...
    for iz=1:1:grid_size(2),
        ...
        for iy=1:1:grid_size(1),
            ...
            fprintf(fpc,'  %2.5f ',V_gust(end-iz+1,1));
...
for t=1:1:(time_gust/time_step),
    ...
    for iz=1:1:grid_size(2),
        ...
        for iy=1:1:grid_size(1),
            ...
            fprintf(fpc,'  %2.5f ',V_gust(end-iz+1,t));
...
for t=1:1:(time_trans_2/time_step),
    ...
    for iz=1:1:grid_size(2),
        ...
        for iy=1:1:grid_size(1),
            ...
            fprintf(fpc,'  %2.5f ',V_gust(end-iz+1,end));
