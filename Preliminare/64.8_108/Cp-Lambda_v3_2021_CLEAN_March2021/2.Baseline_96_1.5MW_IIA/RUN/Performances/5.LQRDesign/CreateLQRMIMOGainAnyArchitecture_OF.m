%==========================================================================
% LQR Synthesis Tool (Output Feedback)
%==========================================================================
% This script can be used to generate LQR gains for the OF case, with 2 
% controls and 4 states
% 
% Directions:
%
% OF case:
%           - set "OutputFeedbackFlag" to one
%           - no weight scheduling: set Q_input and R_input as row vectors 
%           - yes   "      "      : # specify windspeeds in WindTable
%                                   # specify Q_input and R_input; each of
%                                     them can
...
OutputFeedbackFlag = 1 ;    % 1 means OutputFeedback, 0 FullStateFeedback
...
%%% Output Filename %%%
LQR_filename = strcat('LQR_MIMO_OF_Q',num2str(Q_input(3)),'.000_R1.1_1.5MW.mat');
